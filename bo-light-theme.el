(deftheme bo-light
  "Slightly tweaked default gtk light theme for Paperlike HD")

(custom-theme-set-faces
 'bo-light
 '(default ((t (:family "DejaVu Sans Mono" :foundry "PfEd" :width normal :height 128 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "black" :background "white" :stipple nil :inherit nil))))
 ...
 '(highlight ((((class color) (min-colors 88) (background light))
              ...
              (((class color) (min-colors 88) (background dark))
               (:background "darkolivegreen" :foreground "black"))
              ...
              (t (:inverse-video t))))
 '(region ((t (:background "deep sky blue" :distant-foreground "gtk_selection_fg_color"))))
 '(shadow ((((class color grayscale) (min-colors 88) (background light)) (:foreground "grey50")) (((class color grayscale) (min-colors 88) (background dark)) (:foreground "grey70")) (((class color) (min-colors 8) (background light)) (:foreground "green")) (((class color) (min-colors 8) (background dark)) (:foreground "yellow"))))
 '(secondary-selection ((((class color) (min-colors 88) (background light)) (:background "yellow1")) (((class color) (min-colors 88) (background dark)) (:background "SkyBlue4")) (((class color) (min-colors 16) (background light)) (:background "yellow")) (((class color) (min-colors 16) (background dark)) (:background "SkyBlue4")) (((class color) (min-colors 8)) (:foreground "black" :background "cyan")) (t (:inverse-video t))))
 '(trailing-whitespace ((t (:background "dark orange"))))
 ...
 ;;; avy
 '(avy-lead-face ((t (:background "orange"))))
 '(avy-lead-face-0 ((t (:background "orange"))))

 ;;; smartparens
 ;; SEdit mimic
 '(sp-pair-overlay-face ((t (:inherit nil :background "grey80"))))
 '(sp-show-pair-match-content-face ((t (:inherit sp-pair-overlay-face))))

 ;;; treemacs
 '(hydra-face-red ((t (:foreground "dark orange"))))

 ;;; telephone-line
 '(telephone-line-accent-active ((t (:background "grey"))))
 '(telephone-line-projectile ((t (:inherit nil))))
 '(telephone-line-accent-inactive ((t (:background "light grey")))))

(provide-theme 'bo-light)
